...
//				if (joueur == joueurCourant && etape == 1) {
	...
	afficherInfo1.setBounds(Case.TAILLE, (int) (Case.TAILLE * 11.5), Case.TAILLE * 9, (int) (Case.TAILLE * 7.5));
	afficherInfo1.setVisible(false);
	add(afficherInfo1);

	afficherInfo2 = new JLabel();
	afficherInfo2.setBounds(Case.TAILLE + Case.TAILLE * 12, (int) (Case.TAILLE * 11.5), Case.TAILLE * 9, (int) (Case.TAILLE * 7.5));
